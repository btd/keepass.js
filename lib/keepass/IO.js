...
export class FileInfo {
  constructor({cipher = Cipher.DEFAULT, transformRounds = 6000, compression = COMPRESSION.GZIP, masterSeed, transformSeed, encryptionIV, protectedStreamKey, streamStartBytes}) {
...
export class Writer {
  _header(fileInfo) {
    ...
    return Buffer.concat([
      ...
      this._headerField(HEADER_FIELD_ID.CompressionFlags, compressionBuf),
      ...
      this._headerField(HEADER_FIELD_ID.TransformRounds, transformRoundsBuf),
